...
export const MovieView = ({ movies, username, favoriteMovies }) => {
  ...
  const [userFavoriteMovies, setUserFavoriteMovies] = useState(
    storedUser.FavoriteMovies ? storedUser.FavoriteMovies : favoriteMovies
  );

  console.log(username);

  // AddFavMovie
  //API LINK DOES NOT WORK BELOW, NEEDS FIXING
  const addFavoriteMovie = async () => {
    const favoriteMovie = await fetch(
      `https://reman-backend.onrender.com/users/${username}/movies/${movieId}`,
      {
        method: 'POST',
        headers: {
  ...
  //LINK BELOW DOES NOT WORK, NEEDS FIXING
